...
> **La fuente de verdad es el proyecto LaTeX**, que vive en `Documento terabyte SubDoc 5`. Los dos archivos de esta carpeta se generan desde ahí. Si hay discrepancia, manda el PDF.
...
Son el material de respaldo. Todo su contenido está ya volcado en el Subdocumento 5; se conservan porque llevan el razonamiento completo, que el documento final resume.
...
### `diagramas/` — fuentes editables

Los once diagramas de la primera versión en formato Mermaid. **La versión vigente es la 2.1**, que vive en `Documento terabyte SubDoc 5/Diagramas_modelo_conceptual_v2/`, con catorce diagramas, hoja de convenciones y sus PDF vectoriales.
