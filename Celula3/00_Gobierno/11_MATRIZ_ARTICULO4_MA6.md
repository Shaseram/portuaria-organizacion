...
| `STD-A4-30` | AsyncAPI 2.6 o superior | contrato de flujos dirigidos por eventos | baseline **AsyncAPI 3.0** `contract-first`, esquema, semántica, orden, idempotencia, DLQ y versión | `INT-HUB`, EventBridge/SQS y adaptadores | A2 §§1.2/4/5; C2 selección tecnológica; ADR-003 | especificaciones publicadas y pruebas productor/consumidor | SD4 integración | `CUMPLE I1` |
