...
| `SD4-04` | Zero Trust, exposición, identidad, cifrado y controles | D1 | D2, A1, C3 | vista + matriz controles | PENDIENTE |
...
| `STD-02` | ISO/IEC 27002, 27017 y 27018 | controles de seguridad, nube y datos personales | D1/D2 | matriz control–componente–evidencia; privacidad nube | PENDIENTE |
| `STD-03` | NIST CSF 2.0 y NIST SP 800-207 | gobierno de ciberseguridad y Zero Trust | D1/D2 | funciones CSF, políticas de confianza y vista de seguridad | PENDIENTE |
| `STD-04` | OWASP ASVS 4.0 L2, Top 10, API Security Top 10 y SAMM | software, APIs y proceso seguro | D1/C3 | requisitos, pruebas SAST/SCA/DAST y umbral de bloqueo | PENDIENTE |
| `STD-05` | CIS Benchmarks | nube, servidores, edge y endpoints | D1/C2/C3 | baseline de hardening, desviaciones y verificación | PENDIENTE |
| `STD-06` | SLSA 3+, CycloneDX o SPDX y firma de artefactos | cadena de suministro de software | D1/C3 | procedencia, SBOM por versión y verificación de firma | PENDIENTE |
...
| `STD-11` | WCAG 2.2 AA y EN 301 549 | portal, app y terminales | A1/D1; cruce UX | controles de accesibilidad e informe de conformidad | PENDIENTE |
...
| `STD-13` | OpenTelemetry, STRIDE e ISO 31000 | observabilidad, amenazas y riesgo | D1/D2 | trazas correlacionadas, amenazas y registro de riesgos | PENDIENTE |
| `STD-14` | OIDC, OAuth 2.1, SAML 2.0, LDAP y FIDO2 cuando corresponda | identidad e interoperabilidad IAM | D1 | contrato IAM, MFA, federación y prueba de sesiones | PENDIENTE |
| `STD-15` | TLS 1.3 y respaldo 3-2-1-1-0 | comunicaciones y continuidad | D1/C3 | configuración, escaneo, respaldo y restauración probada | PENDIENTE |
...
| `STD-20` | IEC 62443 | segregación de red operacional/protección | C3/D1 | zonas/conductos, aprobación y prueba sin degradar ISPS | PENDIENTE |
