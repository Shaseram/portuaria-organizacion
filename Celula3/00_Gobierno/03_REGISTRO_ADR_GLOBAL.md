...
| `ADR-008` | identidad y acceso Zero Trust; gobierno común con capacidad local delegada como línea base condicionada | D1 | eventuales/PAM; RF-POR-02/09; operación 72 h; aprobación condicionada a F3-ESC-001/002. **2026-09-06: `SRV-IAM` pasa a `Crítica` (A1 §3.1, `F1-DEC-003`), de modo que la capacidad local de autenticación deja de ser línea base condicionada y pasa a ser obligación de continuidad; D1 debe recoger el cambio de alcance** | PROPUESTO | seguridad |
