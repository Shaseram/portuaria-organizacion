...
| `SEC-LOG-01 / SEC-SIEM-01` | registro inalterable, correlación y casos portuarios | plataforma SIEM/log + colectores/buffer local | fuentes nube, on-premise y terreno; repositorio central | buffer 72 h + margen; 12 meses en línea +24 archivados | integridad, corte/reenvío, archivo y reglas B5.1–B5.3/B5.7 | **Fila propia candidata**; C4 dimensiona ingesta, retención y licencias |
...
**Retomar exactamente aquí:** antes de B8, decidir si se publica/intercambia el avance local con los otros frentes. Luego contrastar D1 con aportes reales de A1/A2/A3/C1–C4, D2 y Subdocumento 5; resolver o mantener explícitas las dependencias; ajustar contenido y recién entonces producir los diagramas y la narrativa de informe. B8 no puede aprobar D1 mientras A1–A3/C1–C4/D2 sigan en plantilla o falten productos, cantidades, responsables, pruebas y decisiones externas. ADR-009/010 están `PROPUESTO`; ADR-008 `EN ANÁLISIS`.
...
- No declarar cumplimiento por mencionar una norma ni confundir diseño con certificación institucional. Pruebas previstas no son ejecutadas; SEC-PHYS-v0.1 aún no está completo ni entregado. D2/D3 no se han iniciado por estos bloques.
...
#### B2.7 ADR-008 — propuesta parcial de patrón IAM

- **Fecha:** 2026-09-05.
- **Estado:** EN ANÁLISIS; propuesta parcial, pendiente de validación y selección de producto.
...
- **Decisión:** recomendar C para evaluación, con alcance local acotado según B2.2. No implica dos catálogos independientes ni un producto desarrollado a medida; confirmar soporte de las capacidades en productos antes de cerrar.
...
- **Validación y evidencia:** B2.6; A1/A2/A3 y C1–C4; directorio externo y procedimientos con CLIENTE. F3-ESC-001/002 abiertos.
...
| `B7-F08` | Alta | ADR-008 recomienda C, pero revocación aislada, nombradas y directorio/federación siguen abiertos | conservar `EN ANÁLISIS`; no promoverlo por similitud con ADR-009/010 | ABIERTO — DECISIÓN PENDIENTE |
...
| FEP02 capítulo 11, RT-11.01..28 | **27/28 `EN CURSO`; RT-11.02 `PENDIENTE`** | RT-11.02 requiere el modelo de amenazas D2; ninguna fila está aprobada |
...
|---|---|---|---|---|
| ADR-008 — identidad | continuidad 72 h/8 h, SSO/MFA/PAM, revocación/baja y terminal/eventual | consistencia de autorización, TI=5, directorio/legados y recuperación | alternativa C recomendada; `EN ANÁLISIS` | resolver F3-ESC-001/002, nombradas durante corte, producto, usabilidad y capacidad |
