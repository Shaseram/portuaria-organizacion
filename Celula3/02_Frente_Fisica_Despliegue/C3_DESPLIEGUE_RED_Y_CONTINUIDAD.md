...
| Posición e inventario | crítica | ídem | gateway local, núcleo local, red de patio, terminales | ≤4 h | ≤15 min | **sí**, con la red de patio operativa | **ninguno**: la posición sigue con DGPS/RTLS y lectura óptica local. Lo que se posterga es la conciliación **hacia la nube**; la de plataforma ↔ TOS 2012 continúa localmente, porque `INT-TOS` vive en `PHY-OPS-03`, en la sala *(A3 §4 y §7)*. El terminal de equipo aguanta 8 h fuera de cobertura | prueba de campo con desconexión deliberada | red de patio, **POR ACEPTAR** |
...
| Posición y cruce de zonas | posición con DGPS/RTLS y lectura óptica, **y la conciliación con el TOS 2012, que es local** | la consolidación hacia la nube y la conciliación con contrapartes externas |
