...
- `CH-PORTAL` — Portal público/autenticado, contenido exacto fijado por el Caso 06 (Cap. 15, parámetro "Portal público"; el contenido coincide con BTT `RT-16.31` "portal público accesible sin autenticación" — el Caso 06 lo rotula `RT-16.30` por un desfase de numeración frente a la BTT vigente, ver `F1-CONFLICTO-001`):
