...
|---:|---|---|---|---|
| 1 | [`A1_CONTEXTO_Y_ARQUITECTURA_LOGICA.md`](A1_CONTEXTO_Y_ARQUITECTURA_LOGICA.md) | contexto, ocho capas, componentes y dominio | `trazabilidad/TRZ_A1.md` | PENDIENTE |
