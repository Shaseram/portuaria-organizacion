...
| `TRZ-A1-004` | Caso 06 Cap. 15 (parámetro "Portal público", rotulado allí `RT-16.30`); BTT RT-16.31/32/33/34, RT-13.12; Maestro §3 | MC-06 | RF-POR-01..08 (capa pública sin auth, registro autoservido, consulta autenticada, segregación por contraparte, objeción de factura, cita de inspección, idioma persistente, autoatención) | Portal público/autenticado con contenido exacto del caso (consulta sin auth, citas/objeciones/curva de temperatura con auth), bilingüe, resistente a picos (CH-PORTAL) | §1.1, §2.2 (Capa 1) | D1 | PARA REVISIÓN |
...
| `TRZ-A1-008` | Caso 06 Caps. 7/14; Maestro §4.2 | MC-15 | RF-PAT-01..13 | Patio y posición (CTX-YARD) con verificación cruzada y ≤0,5 % por verificar | §2.2 (Capa 4), §3.1 | C1/C4 | PARA REVISIÓN |
...
| `TRZ-A1-030` | Maestro §4.7, §11.2; Ley 19.799; BTT RT-16.17/18 | MC-05 | RF-FIR-01 | Evidencia y firma digital (SRV-EVID) en los cuatro actos (embarque, recepción/entrega, acta de inspección, hechos facturables) conforme a Ley 19.799, sellos e integridad verificable | §2.2 (Capa 7), §3.1 | D1/D2 | PARA REVISIÓN |
