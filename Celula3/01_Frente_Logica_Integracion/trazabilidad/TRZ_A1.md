...
| `TRZ-A1-004` | Caso 06 Cap. 15; BTT RT-16.31/32; Maestro §3 | MC-06 | RF-POR-01 | Portal público/autenticado con dato mínimo seguro, accesible sin autenticación para consulta general y con autoatención (CH-PORTAL) | §1.1, §2.2 (Capa 1) | D1 | PARA REVISIÓN |
...
| `TRZ-A1-007` | Caso 06 Cap. 6; Maestro §4.2 | — | RF-GAT-01..08 | Gate y citas (CTX-GATE) con prevalidación, cola virtual, excepciones y ≤120 s por camión | §2.2 (Capa 4), §3.1 | C1/C4 | PARA REVISIÓN |
| `TRZ-A1-008` | Caso 06 Caps. 7/14; Maestro §4.2 | MC-15 | RF-PAT-01..07 | Patio y posición (CTX-YARD) con verificación cruzada y ≤0,5 % por verificar | §2.2 (Capa 4), §3.1 | C1/C4 | PARA REVISIÓN |
| `TRZ-A1-009` | Caso 06 Cap. 7; Maestro §4.2 | MC-08/10 | RF-REE-01..06 | Reefer y telemetría (CTX-REEFER) con alarma ≤5 min, 2.400/2.900 tomas y series temporales | §2.2 (Capa 4), §3.1 | C1/C4/D1 | PARA REVISIÓN |
| `TRZ-A1-010` | Caso 06 Cap. 7; Maestro §4.2 | — | RF-PLN-01..05 | Planificación (CTX-PLAN) con captura de reglas tácitas y propuesta/corrección/aprendizaje | §2.2 (Capa 4), §3.1 | C1 | PARA REVISIÓN |
| `TRZ-A1-011` | Caso 06 Cap. 7; Maestro §14 | MC-20/23 | RF-NAV-01..08 | Nave y mensajería (CTX-VESSEL) con BAPLIE/COPRAR/COARRI/CODECO y ventana ≥72 h | §2.2 (Capa 4), §3.1 | A2/C1 | PARA REVISIÓN |
| `TRZ-A1-012` | Caso 06 Cap. 7; Maestro §4.7 | MC-05 | RF-FAC-01..05 | Evidencia facturable (CTX-BILL) con cuatro actos de firma y entrega al ERP | §2.2 (Capa 4), §3.1 | A2/D1 | PARA REVISIÓN |
| `TRZ-A1-013` | Caso 06 Cap. 7; Maestro §4.7 | MC-21 | RF-INS-01..04 | Inspecciones (CTX-INSP) con remoción anticipada y acta firmada | §2.2 (Capa 4), §3.1 | A2/D1 | PARA REVISIÓN |
| `TRZ-A1-014` | Caso 06 Cap. 7; Maestro §14 | MC-16/17/25 | RF-EMI-01..04 | Energía y emisiones (CTX-EMIS) con ISO 14083 y verificación efectiva por tercero | §2.2 (Capa 4), §3.1 | C4 | PARA REVISIÓN |
| `TRZ-A1-015` | BTT RT-11.01, RT-12.02/03/05/06/10/11; Maestro §11 | MC-04 | RNF-SEG-01..12 | Identidad y autorización (SRV-IAM) con Zero Trust (RT-11.01), SSO, MFA, RBAC+ABAC (RT-12.05), PAM (RT-12.06), baja ≤24 h (RT-12.10) y credencial de eventuales adecuada al perfil operacional de terreno sin biometría obligatoria (RT-12.11, Según caso) | §2.2 (Capa 7), §3.1 | D1 | PARA REVISIÓN |
| `TRZ-A1-016` | Caso 06 Cap. 14; Maestro §7; BTT RT-02.07 | MC-03/12 | RF-INT-01..12 | Hub de integración (INT-HUB) con 21 contrapartes + 7 familias, gobierno de contratos, entrega al menos una vez y orden garantizado por partición/agregado | §2.2 (Capa 5), §3.1 | A2/C4 | PARA REVISIÓN |
...
| `TRZ-A1-020` | Maestro §5.2; Caso 06 Cap. 5 | MC-02 | RF-VMS-01 | VMS conservado; solo eventos/metadatos/evidencia confirmados; no portal de video | §1.3 | A2/D1 | PARA REVISIÓN |
| `TRZ-A1-021` | Maestro §3; Caso 06 Cap. 16.1 (pendiente N° 10) | MC-03 | RF-NOT-01..04 | Notificaciones compartidas (SRV-NOTIF) con adaptadores de canal, canal redundante reefer y escalamiento automático a supervisor si nadie confirma | §2.2 (Capa 4), §3.1 | A2 | PARA REVISIÓN |
| `TRZ-A1-022` | Maestro §16; Caso 06 Cap. 16 | MC-26 | RNF-DAT-01..05 | Cuatro tipos de persistencia separados por naturaleza del dato (CORE/TS/DOC/AN) | §2.2 (Capa 6), §3.2 | C2/C4 | PARA REVISIÓN |
...
| `TRZ-A1-029` | Maestro §3, §4.6, §17; Caso 06 Cap. 16.1 (pendiente N° 9) | Decisiones 14-15 | — | Interfaz de cabina/terreno (CH-CAB): sin confirmación rutinaria, telemetría como fuente primaria, tolerancia de 8 h de sombra de radio en patio y reconciliación por marca de tiempo del equipo al recuperar señal | §2.2 (Capa 1), §3.1, §3.2 | C1/C3/D1 | PARA REVISIÓN |
| `TRZ-A1-030` | Maestro §4.7, §11.2; Ley 19.799; BTT RT-16.17/18 | MC-05 | RF-FAC (vía CTX-BILL) | Evidencia y firma digital (SRV-EVID) en los cuatro actos (embarque, recepción/entrega, acta de inspección, hechos facturables) conforme a Ley 19.799, sellos e integridad verificable | §2.2 (Capa 7), §3.1 | D1/D2 | PARA REVISIÓN |
...
|---|---|---|---|---|
| `TRZ-A1-ACT-01` | ACT-OPS a ACT-COM (9 internos) | Maestro §5.1; Caso 06 Caps. 1, 2, 7 | RF-CON, RF-GAT, RF-REE, RF-PLN, RF-APP | §1.2 |
| `TRZ-A1-ACT-02` | ACT-NAV a ACT-VER (7 externos) | Maestro §5.1; Caso 06 Caps. 6, 14 | RF-NAV, RF-INT, RF-INS, RF-EMI, RF-POR | §1.2 |
